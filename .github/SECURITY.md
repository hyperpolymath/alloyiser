...
Replace all {{PLACEHOLDER}} values with your information:
  What Is Alloyiser?     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  alloyiser             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/alloyiser/security/advisories/new)
...
- This repository (`hyperpolymath/alloyiser`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/alloyiser/security/advisories)
...
When using What Is Alloyiser?, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/alloyiser/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/alloyiser/security/advisories/new) or {{SECURITY_EMAIL}} |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/alloyiser/discussions) |
...
*Thank you for helping keep What Is Alloyiser? and its users safe.* 🛡️
